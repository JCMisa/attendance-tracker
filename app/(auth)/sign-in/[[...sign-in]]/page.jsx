                ...
                <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
                    <div className="max-md:order-1 flex flex-col justify-center space-y-16 max-md:mt-16 min-h-full bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8 px-4 py-4">
                        <div>
                            ...
                            <p className="text-[13px] text-gray-300 mt-3 leading-relaxed">Quickly log in to continue where you left off.</p>
                        </div>
                        <div>
                            <h4 className="text-white text-lg font-semibold">Simple & Secure Login</h4>
                            <p className="text-[13px] text-gray-300 mt-3 leading-relaxed">Our login process is designed to be straightforward and secure. We prioritize your privacy and data security.</p>
                        </div>
                    </div>
