            ...
            <footer className="text-gray-400 bg-secondary body-font">
                <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
                        <Image width={10} height={10} src={'/attendo-logo.png'} alt='logo' className="w-10 h-10 text-white p-2 bg-secondary rounded-full" />
                        <span className="ml-3 text-xl">Attendo</span>
                    </a>
                    <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2024 Attendo —
